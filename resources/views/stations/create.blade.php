        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{__('Créer Une Station')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-lg-6 mx-auto">
                <div class="card border">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="POST" action="{{ route('stations.store') }}">
                            @csrf
                            <div class="form-group mb-3">
                                <label for="name_french">{{ __('Nom Francais') }}</label>
                                <input name="name_french" type="text" class="form-control" id="name_french" @error('name_french') is-invalid @enderror placeholder="{{ __('Nom Francais') }}" value="{{old('name_french')}}" required>
                                @error('name_french')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="name_arab" type="text" class="form-control" id="name_arab" @error('name_arab') is-invalid @enderror placeholder="{{ __('Nom Arabe') }}" value="{{old('name_arab')}}" required>
                                @error('name_arab')
                                <span class="invalid-feedback" style="display: block !important;" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="num" type="text" class="form-control" id="validationCustom01" @error('num') is-invalid @enderror placeholder="{{ __('Numéro') }}" value="{{old('num')}}" required>
                                @error('num')
                                <span class="invalid-feedback" style="display: block !important;" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Saisir la Latitude.." name="lat" id="house_lat" value="36.0887208">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="house_lng">Longitude</label>
                                        <input type="text" class="form-control" placeholder="Saisir la Longitude.." name="long" id="house_lng" value="9.3645335">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="lines[]" class="form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="{{ __('choisir les lignes') }}">
                                    @foreach($line as $line)
                                        <option value="{{$line->id}}">{{ __('Ligne numéro') }} : {{$line->num}}</option>>
                                    @endforeach
                                </select>
