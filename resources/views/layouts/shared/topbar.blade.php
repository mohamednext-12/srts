...
{{--            </li>--}}
            ...
            <li class="dropdown d-inline-block ">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light"  href="{{route('subscriptions.create')}}" role="button" aria-haspopup="false" aria-expanded="false">
