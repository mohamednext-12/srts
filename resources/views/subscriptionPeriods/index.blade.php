                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('Liste des Periodes')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('Liste des Periodes')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="{{route('subscriptionPeriods.create')}}" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i>
                                    {{__('Ajouter une Période')}}</a>
                            </div>
                            <!-- end col-->
                        </div>
    ...
    <script>
        $(function () {
            ...
            var table = $('#customers-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('subscriptionPeriods.index') }}",
                columns: [
