                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('Période')}}</a></li>
                            <li class="breadcrumb-item active">{{__('Modifier Une Période')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('Modifier Une Période')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
