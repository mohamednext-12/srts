                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('agencies.index')}}">{{__('Agences')}}</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card-box bg-pattern">
                        <div class="text-center">
                            <img src="{{asset('assets/images/default_agency.jpg')}}"alt="logo" class="avatar-xl rounded-circle mb-3">
                            <h4 class="mb-1 font-20">{{app()->getLocale()=='fr' ? $agency->name_french : $agency->name_arab }}</h4>
                            <p class="text-muted  font-14 mb-0">
                                {{__('Code')}} : {{$agency->code}}
                            </p>
                            <p class="text-muted  font-14">
                                {{__('Municipalité')}} : {{app()->getLocale()=='fr' ? $agency->municipality->name_french : $agency->municipality->name_arab}}
                            </p>
                        </div>
...
{{--                        </div>--}}
                        <div class="row">
                            <div class="col-6 float-right">
                                <a href="{{route('agencies.edit',$agency)}}" class="btn float-right btn-info">{{__('Modifier')}}</a>

                            </div>
                            <div class="col-6 float-right">
                                <a class="btn btn-success  mr-2" href="{{route('agencies.index')}}">{{ __('Retour') }}</a>
                            </div>
                        </div>
...
{{--    </script>--}}
    <script>
        ...
        var geocoder;
        function initMap() {
            var iconBase = "{{asset('assets/images/marker_agency.png')}}";
