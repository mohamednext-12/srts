                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div>
                            ...
                            <p class="faq-answer mb-4 pb-1">
                                Use our dedicated support email (support@Next.com) to send your issues or feedback. We are here to help anytime.
                            </p>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        <div class="text-md-right">
                            <a href="https://Next.com/#contact" class="btn btn-primary btn-lg">
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-md-3 offset-md-4">
                        ...
                        <ul class="list-unstyled mb-0 mt-3 footer-list">
                            <li><a target="_blank" href="https://Next.com/#contact">Support</a></li>
                            <li><a target="_blank" href="https://Next.com/#contact">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="float-left pull-none">
                            <p class="">2020 © Ubold. Design by <a href="https://Next.com/" target="_blank" class="">Next.com</a> </p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
