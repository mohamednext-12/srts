                                        ...
                                        @foreach($receipts as $rec)
                                            <optgroup  label="{{$rec->receipt}}">
                                                @foreach(\App\Chain::lots($rec->receipt) as $lot)
                                                    <option data-max="{{$lot['max']}}" data-min="{{$lot['min']}}" data-receipt="{{$rec->receipt}}">{{$lot['min']}} -> {{$lot['max']}} : {{$lot['type']}} </option>
{{--                                                    <option >{{$lot}}</option>--}}
                                                @endforeach
                                            </optgroup>
                                        @endforeach
    ...
    <script>
        ...
        $('#add').click(function () {
            if (verifAdd()) {
                $('#stock').append(
                    '<tr>'+
                    '<td>'+$('#receipts option:selected').attr('data-receipt')+'</td>'+
                    '<td>'+$('#start').val()+'</td>'+
                    '<td>'+$('#end').val()+'</td>'+
        ...
        $('body').on('change','#receipts', function () {
            ...
            let first = $('#receipts option:selected').attr('data-min');
            console.log(first);
            let last = $('#receipts option:selected').attr('data-max');
            console.log(last);
            $('#start').val(first);
            $('#end').val(last);
