                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-striped dt-responsive nowrap w-100" id="customers-datatable">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('Scolaire')}}</th>
                                    <th>{{__('Reste Scolaire')}}</th>
                                    <th>{{__('Civile')}}</th>
                                    <th>{{__('Reste Civile')}}</th>
        ...
        $(function () {
            var table = $('#customers-datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'envoyee', name: 'envoyee'},
                    {data: 'reste', name: 'reste'},

                    {data: 'scolaire', name: 'scolaire'},
                    {data: 'resteScolaire', name: 'resteScolaire'},
                    {data: 'civile', name: 'civile'},
                    {data: 'resteCivile', name: 'resteCivile'},
